...
I made everything in Unity 5. Consequently, for Unity 4, there are no prefabs and you have to setup everything from scratch. It's very easy, but requires dragging script files on to an empty game object and setting up materials and textures. See the Getting Started tutorial.
**********************
